...
import kata.wordbuilder.WordBuilder;
import kata.wordbuilder.WordBuilder2;
...
public class WordBuilderTest {
    ...
    private static final File dictionaryFile = new File("src/test/java/kata/wordbuilder/en-GB.dic");
