...
public class Calculator {
	 ...
	 * keyword.
	 */
	public interface Iface extends thrift.SharedService.Iface {

		/**
		 * A method definition looks like C code. It has a return type,
		 * arguments, and optionally a list of exceptions that it may throw.
		 * Note that argument lists and exception lists are specified using the
		 * exact same syntax as field lists in struct or exception definitions.
		 */
		...
		/**
		 * This method has a oneway modifier. That means the client only makes a
		 * request and does not listen for any response at all. Oneway methods
		 * must be void.
		 */
	...
	public interface AsyncIface extends thrift.SharedService.AsyncIface {
		...
		public void calculate(
				int logid,
				Work w,
				org.apache.thrift.async.AsyncMethodCallback<AsyncClient.calculate_call> resultHandler)
				throws org.apache.thrift.TException;

		public void zip(
				org.apache.thrift.async.AsyncMethodCallback<AsyncClient.zip_call> resultHandler)
				throws org.apache.thrift.TException;

	}

	public static class Client extends thrift.SharedService.Client implements
			Iface {
		...
		public int recv_calculate() throws InvalidOperation,
				org.apache.thrift.TException {
	...
	public static class AsyncClient extends thrift.SharedService.AsyncClient
		...
		public void add(
				...
				throws org.apache.thrift.TException {
			checkReady();
			add_call method_call = new add_call(num1, num2, resultHandler,
		...
		public void calculate(
				int logid,
				Work w,
				org.apache.thrift.async.AsyncMethodCallback<calculate_call> resultHandler)
				throws org.apache.thrift.TException {
			checkReady();
			calculate_call method_call = new calculate_call(logid, w,
					resultHandler, this, ___protocolFactory, ___transport);
			this.___currentMethod = method_call;
			___manager.call(method_call);
		}

		public static class calculate_call extends
				org.apache.thrift.async.TAsyncMethodCall {
			private int logid;
			private Work w;

			public calculate_call(
					int logid,
					Work w,
					org.apache.thrift.async.AsyncMethodCallback<calculate_call> resultHandler,
					org.apache.thrift.async.TAsyncClient client,
			...
			public int getResult() throws InvalidOperation,
					org.apache.thrift.TException {
				if (getState() != org.apache.thrift.async.TAsyncMethodCall.State.RESPONSE_READ) {
					throw new IllegalStateException("Method call not finished!");
				}
		...
		public void zip(
				org.apache.thrift.async.AsyncMethodCallback<zip_call> resultHandler)
				throws org.apache.thrift.TException {
			checkReady();
		...
		public static class zip_call extends
			...
			public void write_args(org.apache.thrift.protocol.TProtocol prot)
					throws org.apache.thrift.TException {
				prot.writeMessageBegin(new org.apache.thrift.protocol.TMessage(
						"zip", org.apache.thrift.protocol.TMessageType.CALL, 0));
				zip_args args = new zip_args();
				args.write(prot);
				prot.writeMessageEnd();
			}
	...
	public static class Processor<I extends Iface> extends
			thrift.SharedService.Processor<I> implements
		...
		public static class calculate<I extends Iface> extends
				org.apache.thrift.ProcessFunction<I, calculate_args> {
			public calculate() {
				super("calculate");
			}
			...
			public calculate_result getResult(I iface, calculate_args args)
					throws org.apache.thrift.TException {
				calculate_result result = new calculate_result();
				try {
		...
		public static class zip<I extends Iface> extends
			...
			public org.apache.thrift.TBase getResult(I iface, zip_args args)
					throws org.apache.thrift.TException {
				iface.zip();
				return null;
			}
	...
	public static class add_args implements
		...
		public int compareTo(add_args other) {
			...
			lastComparison = Boolean.valueOf(isSetNum1()).compareTo(
					typedOther.isSetNum1());
			if (lastComparison != 0) {
				return lastComparison;
			}
			if (isSetNum1()) {
				lastComparison = org.apache.thrift.TBaseHelper.compareTo(
						this.num1, typedOther.num1);
				if (lastComparison != 0) {
					return lastComparison;
				}
			}
			lastComparison = Boolean.valueOf(isSetNum2()).compareTo(
					typedOther.isSetNum2());
			if (lastComparison != 0) {
				return lastComparison;
			}
			if (isSetNum2()) {
				lastComparison = org.apache.thrift.TBaseHelper.compareTo(
						this.num2, typedOther.num2);
				if (lastComparison != 0) {
					return lastComparison;
				}
			}
	...
	public static class calculate_args implements
			org.apache.thrift.TBase<calculate_args, calculate_args._Fields>,
			java.io.Serializable, Cloneable {
		private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct(
				"calculate_args");

		private static final org.apache.thrift.protocol.TField LOGID_FIELD_DESC = new org.apache.thrift.protocol.TField(
				"logid", org.apache.thrift.protocol.TType.I32, (short) 1);
		private static final org.apache.thrift.protocol.TField W_FIELD_DESC = new org.apache.thrift.protocol.TField(
				"w", org.apache.thrift.protocol.TType.STRUCT, (short) 2);
		...
		static {
			...
			tmpMap.put(_Fields.LOGID,
					new org.apache.thrift.meta_data.FieldMetaData("logid",
							org.apache.thrift.TFieldRequirementType.DEFAULT,
							new org.apache.thrift.meta_data.FieldValueMetaData(
									org.apache.thrift.protocol.TType.I32)));
			tmpMap.put(_Fields.W,
					new org.apache.thrift.meta_data.FieldMetaData("w",
							org.apache.thrift.TFieldRequirementType.DEFAULT,
			...
			metaDataMap = Collections.unmodifiableMap(tmpMap);
			org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(
					calculate_args.class, metaDataMap);
		}
		...
		/**
		 * Returns true if field logid is set (has been assigned a value) and
		 * false otherwise
		 */
		...
		/**
		 * Returns true if field w is set (has been assigned a value) and false
		 * otherwise
		 */
		...
		public int compareTo(calculate_args other) {
			...
			lastComparison = Boolean.valueOf(isSetLogid()).compareTo(
					typedOther.isSetLogid());
			if (lastComparison != 0) {
				return lastComparison;
			}
			if (isSetLogid()) {
				lastComparison = org.apache.thrift.TBaseHelper.compareTo(
						this.logid, typedOther.logid);
				if (lastComparison != 0) {
					return lastComparison;
				}
			}
			lastComparison = Boolean.valueOf(isSetW()).compareTo(
					typedOther.isSetW());
			if (lastComparison != 0) {
				return lastComparison;
			}
		...
		private static class calculate_argsStandardSchemeFactory implements
				SchemeFactory {
		...
		private static class calculate_argsStandardScheme extends
				StandardScheme<calculate_args> {

			public void read(org.apache.thrift.protocol.TProtocol iprot,
					calculate_args struct) throws org.apache.thrift.TException {
				org.apache.thrift.protocol.TField schemeField;
				iprot.readStructBegin();
				while (true) {
					schemeField = iprot.readFieldBegin();
		...
		private static class calculate_argsTupleSchemeFactory implements
				SchemeFactory {
		...
		private static class calculate_argsTupleScheme extends
				TupleScheme<calculate_args> {
	...
	public static class calculate_result
			implements
			org.apache.thrift.TBase<calculate_result, calculate_result._Fields>,
			java.io.Serializable, Cloneable {
		private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct(
				"calculate_result");
		...
		private static final org.apache.thrift.protocol.TField SUCCESS_FIELD_DESC = new org.apache.thrift.protocol.TField(
				"success", org.apache.thrift.protocol.TType.I32, (short) 0);
		private static final org.apache.thrift.protocol.TField OUCH_FIELD_DESC = new org.apache.thrift.protocol.TField(
				"ouch", org.apache.thrift.protocol.TType.STRUCT, (short) 1);
		 ...
		 */
		public enum _Fields implements org.apache.thrift.TFieldIdEnum {
			SUCCESS((short) 0, "success"), OUCH((short) 1, "ouch");
		...
		static {
			...
			tmpMap.put(_Fields.OUCH,
					new org.apache.thrift.meta_data.FieldMetaData("ouch",
							org.apache.thrift.TFieldRequirementType.DEFAULT,
							new org.apache.thrift.meta_data.FieldValueMetaData(
									org.apache.thrift.protocol.TType.STRUCT)));
			metaDataMap = Collections.unmodifiableMap(tmpMap);
			org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(
					calculate_result.class, metaDataMap);
		}

		public calculate_result() {
		}

		public calculate_result(int success, InvalidOperation ouch) {
			this();
			this.success = success;
			setSuccessIsSet(true);
			this.ouch = ouch;
		...
		/**
		 * Returns true if field ouch is set (has been assigned a value) and
		 * false otherwise
		 */
		...
		public int compareTo(calculate_result other) {
			...
			lastComparison = Boolean.valueOf(isSetOuch()).compareTo(
					typedOther.isSetOuch());
			if (lastComparison != 0) {
				return lastComparison;
			}
			if (isSetOuch()) {
				lastComparison = org.apache.thrift.TBaseHelper.compareTo(
						this.ouch, typedOther.ouch);
				if (lastComparison != 0) {
					return lastComparison;
				}
			}
		...
		private static class calculate_resultStandardSchemeFactory implements
				SchemeFactory {
		...
		private static class calculate_resultStandardScheme extends
				StandardScheme<calculate_result> {

			public void read(org.apache.thrift.protocol.TProtocol iprot,
					calculate_result struct)
					throws org.apache.thrift.TException {
				org.apache.thrift.protocol.TField schemeField;
				iprot.readStructBegin();
				while (true) {
		...
		private static class calculate_resultTupleSchemeFactory implements
				SchemeFactory {
		...
		private static class calculate_resultTupleScheme extends
				TupleScheme<calculate_result> {
	...
	public static class zip_args implements
			org.apache.thrift.TBase<zip_args, zip_args._Fields>,
			java.io.Serializable, Cloneable {
		private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct(
				"zip_args");
		...
		private static class zip_argsStandardScheme extends
			...
			public void read(org.apache.thrift.protocol.TProtocol iprot,
					zip_args struct) throws org.apache.thrift.TException {
				org.apache.thrift.protocol.TField schemeField;
				iprot.readStructBegin();
				while (true) {
					schemeField = iprot.readFieldBegin();
		...
		private static class zip_argsTupleSchemeFactory implements
				SchemeFactory {
